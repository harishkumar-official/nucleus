...
public class ClientController {
  ...
  public String create(
      @PathVariable String client, @PathVariable String entity, @RequestBody Document doc) {
  ...
  public Long primaryFieldsUpdate(
      @PathVariable String client,
      @PathVariable String entity,
  ...
  public Long delete(
    ...
    return dataService.deleteInEntityArray(
        client, entity, request.getIds(), request.getUpdates(), request.getArraySize());
  }
  ...
  @RequestMapping(
      value = "/{client}/entity/{entity}/get",
  ...
  public List<Map<String, Object>> get(
    ...
    List<Map<String, Object>> result =
        dataService.getEntities(client, entity, query, returnFields, withAssData);

    if (!StringUtils.isEmpty(returnFields)) {
      for (Map<String, Object> partner : result) {
        List<String> removedFields =
            partner.keySet().stream()
                .filter(key -> !returnFields.contains(key))
