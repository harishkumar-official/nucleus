...
public class MetadataController {
  ...
  public String create(
      @RequestBody MetadataCreateRequest request, @PathVariable("client") String client) {
  ...
  public Boolean update(
      @RequestBody MetadataUpdateRequest request, @PathVariable("client") String client) {
  ...
  public Boolean delete(
      @RequestBody MetadataDeleteRequest request, @PathVariable("client") String client) {
    return dataService.deleteInMetaArray(
        request.getIds(), client, request.getArraySize(), request.getUpdates());
  }
  ...
  public List<Map<String, Object>> get(
      @PathVariable("client") String client, @RequestParam(required = false) String localization) {
