...
public class Entity {
  ...
  @JsonIgnore
  Map<List<String>, String> fieldToReferenceEntityMapForManyToMany;
  @JsonIgnore
  Map<List<String>, String> fieldToReferenceEntityMapForManyToOne;
  @JsonIgnore
  List<String> primaryFieldsName;
  ...
  public Map<List<String>, String> getFieldToReferenceEntityMapForManyToMany() {
    if (fieldToReferenceEntityMapForManyToMany == null || fieldToReferenceEntityMapForManyToMany.isEmpty()) {
      fieldToReferenceEntityMapForManyToMany = getFieldToReferenceEntityMap(fields, AssociationType.many_to_many);
    }
  ...
  public Map<List<String>, String> getFieldToReferenceEntityMapForManyToOne() {
    if (fieldToReferenceEntityMapForManyToOne == null || fieldToReferenceEntityMapForManyToOne.isEmpty()) {
      fieldToReferenceEntityMapForManyToOne = getFieldToReferenceEntityMap(fields, AssociationType.many_to_one);
    }
    return fieldToReferenceEntityMapForManyToOne;
  }

  private static Map<List<String>, String> getFieldToReferenceEntityMap(List<Field> fields,
    ...
    if (fields != null) {
      for (Field field : fields) {
        ...
        if (assType != null && associationType.name().equals(assType)) {
          ...
          Map<List<String>, String> internalMap = getFieldToReferenceEntityMap(field.getFields(), associationType);
